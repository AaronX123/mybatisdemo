package com.bosssoft.hr.train.snowflake;
...
public class SnowFlake {
    ...
    public synchronized long nextId() throws BusinessException {
        ...
        if (timestamp < lastTimestamp) {
            throw new BusinessException(EnumBusinessError.SNOWFLAKE_GENERATE_ERROR.setErrorMessage(String.format("Clock moved backwards.  Refusing to generate id for %d milliseconds", lastTimestamp - timestamp)));
